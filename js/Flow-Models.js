...
return self;},
args: ["aReifiedJSON"],
source: unescape('syncWith%3A%20aReifiedJSON%0A%09%22Sync%20the%20current%20values%20in%20this%20model%20%0A%09with%20the%20ones%20coming%20in%20aReifiedJSON.%22%0A%09%7C%20instVarsToSync%20%7C%0A%0A%09instVarsToSync%20%3A%3D%20self%20class%20allInstanceVariableNames%20reject%3A%5B%3Ae%7C%20self%20class%20jsonIgnoreInstanceVariables%20includes%3A%20e%5D.%0A%09instVarsToSync%20do%3A%5B%3AinstVarName%7C%20%7Cvalue%7C%0A%09%09value%20%3A%3D%20aReifiedJSON%20at%3A%20instVarName.%0A%0A%09%09%22If%20the%20reified%20value%20looks%20like%20a%20model%2C%20we%20compose%20it.%22%0A%09%09%28value%20isKindOf%3A%20JSObjectProxy%29%20ifTrue%3A%5B%0A%09%09%09value%20%3A%3D%20self%20class%20reify%3A%20instVarName%20from%3A%20value%5D.%0A%0A%09%09self%20%0A%09%09%09instVarAt%3A%20instVarName%20%0A%09%09%09put%3A%20value%5D.%0A'),
messageSends: ["reject:", "allInstanceVariableNames", "class", "includes:", "jsonIgnoreInstanceVariables", "do:", "at:", "ifTrue:", "isKindOf:", "reify:from:", "instVarAt:put:"],
...
return self;},
args: ["someJson"],
source: unescape('fromJson%3A%20someJson%0A%0A%09%5E%20self%20new%20syncFrom%3A%20someJson'),
...
source: unescape('%20reify%3A%20instVarName%20from%3A%20aReifiedJSON%0A%09%22Makes%20this%20class%20to%20answer%20a%20reified%20instance%20of%20its%20expected%20value%20at%20its%20instVar%20named%0A%09instVarName.%20All%20that%20based%20on%20aReifiedJSON.%0A%09Note%3A%20in%20order%20to%20work%2C%20this%20assumes%20you%20have%20implemented%20%28in%20the%20class%0A%09side%29%20methods%20looking%20like%20%5BvarName%5DFrom%3A%20%0A%09Example%3A%20%20User%20class%3E%3EpersonFrom%3A%20%0A%09that%2C%20is%20expected%20to%20return%20the%20first%20class%20Amber%20citizen%20and%20properly%20instanciated%20aPerson%20object.%22%0A%0A%09%7C%20reifierMethod%20%7C%0A%0A%09reifierMethod%20%3A%3D%20instVarName%2C%27From%3A%27.%0A%0A%09%28self%20respondsTo%3A%20reifierMethod%29%20ifFalse%3A%5B%0A%09%09MissingInstanceVariableReifier%20signal%3A%20%27Please%20implement%3A%20%27%2C%20self%20name%2C%27%20class%3E%3E%27%2C%20reifierMethod%2C%20%27%20to%20properly%20reify%20that%20instance%20variable%27.%5D.%0A%0A%09%5E%20self%20perform%3A%20reifierMethod%20asSymbol%20withArguments%3A%20%28Array%20with%3A%20aReifiedJSON%29'),
